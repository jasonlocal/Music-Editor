 ...
 * the name of the main type is for a model, we parameterize this builder
 * interface by an unknown type.
 *
...
public interface CompositionBuilder<T> {
   ...
   * @return the resulted composition
   */
  CompositionBuilder<T> addNote(int start, int end, int instrument,
